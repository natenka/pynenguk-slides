...
| Set         | Для збереження унікальних даних. Часто використовується |
|             | для операцій з множинами |
| Boolean     | Вказує, що певне значення є істинним або хибним |
| None        | Використовується, коли потрібно вказати, що значення тут немає |
