...
Набагато простіше і правильніше винести цей код у функцію (це може бути кілька
функцій). І тоді буде просто здійснюватися виклик цієї функції – у цьому файлі
чи якомусь іншому.
