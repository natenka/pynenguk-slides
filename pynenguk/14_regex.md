...
Вираз ``\d\d:\d\d:\d\`` описує 3 пари чисел, розділених двокрапками.
...
Вираз ``\w\w\w\.\w\w\w\w\.\w\w\w`` описує 12 букв або цифр, які розділені на три групи по чотири символи крапками .
...
Ще один приклад виразу: ``\d+\s+\S+``` - воно описує рядок, в якому йдуть цифри, пробіл (whitespace), не whitespace символи, тобто все, крім пробілу, табу та інших whitespace символів.
...
Тобто, в лівій частині адреси може бути одне слово, або два слова, розділені точкою.
...
Але такий вираз не підходить для email з точкою:
```python
